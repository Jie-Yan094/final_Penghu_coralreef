    ...
    with solara.Column(align="center", style={"text-align": "center", "width": "100%"}):
        ...
        with solara.Column(style={"max-width": "800px"}):
            solara.Markdown(
                ...
                本專案運用 Google Earth Engine 的開放資料，分類與分析 2016 年至 2025 年間的衛星影像，試圖從數據中拼湊出珊瑚礁棲地的消長。
        ...
        solara.Markdown(""" 
                        * **澎湖地形以玄武岩方山與低平島為主，特色是海岸線曲折，缺乏大河川，但周邊海域因湧升流帶來豐富營養鹽，形成多變的海底地形，珊瑚礁生態系發達，尤其在內灣及南方四島海域，有豐富的硬珊瑚、軟珊瑚，構成繽紛的海底世界，但近年面臨暖化白化的挑戰，復育工作正在進行中。**
                        * 珊瑚礁生態與分布
                        * 主要區域: 以馬公本島的青灣、南方四島（如東吉嶼、忘憂島、東嶼坪）為主要珊瑚礁區。
                        * 珊瑚種類: 包括軸孔珊瑚、盤狀珊瑚、軟珊瑚等，群聚形成海底花園。
                        * 地形與珊瑚共生: 礁盤與沙溝交錯，大石塊和珊瑚團塊提供魚群躲藏空間。
                        * 復育區: 忘憂島等地設有珊瑚復育區，透過旅遊結合復育，種植幼小珊瑚，監控生長。 
                        """)
